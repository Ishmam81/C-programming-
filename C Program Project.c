...
// Function to edit a tourist's details

void editTourist() {

int id;

printf("Enter Tourist ID to edit: ");
...
printf("Editing details for Tourist ID %d:\n", id);
...
printf("Tourist details updated successfully!\n");
